...
//list of buildings and info pages for admin sections
public class EditList extends AppCompatActivity {
    ...
    public static final DetailsBuildings[] BUILDINGS = {
            ...
            new DetailsBuildings(R.string.keynes_soc_sci_name,
                    R.drawable.buildings_keynes,
                    EditInfo.class),
            ...
            new DetailsBuildings(R.string.marlowe_arch_name,
                    R.drawable.buildings_marlowe,
                    EditInfo.class),

            new DetailsBuildings(R.string.marlowe_anthro_name,
                    R.drawable.buildings_marlowe,
                    EditInfo.class),
            ...
            new DetailsBuildings(R.string.rutherford_human_name,
                    R.drawable.buildings_rutherford,
                    EditInfo.class),

            new DetailsBuildings(R.string.rutherford_social_sci_name,
                    R.drawable.buildings_rutherford,
                    EditInfo.class),
            ...
            new DetailsBuildings(R.string.sibson_sci_name,
                    R.drawable.buildings_sibson,
                    EditInfo.class),

            new DetailsBuildings(R.string.sibson_soc_sci_name,
                    R.drawable.buildings_sibson,
                    EditInfo.class),
            ...
            new DetailsBuildings(R.string.faq_name,
                    R.drawable.buildings_faq,
                    FAQEdit.class),

            new DetailsBuildings(R.string.contact_name,
                    R.drawable.admin_contact,
                    ContactEdit.class),

            new DetailsBuildings(R.string.credits_name,
                    R.drawable.buildings_credits,
                    CreditsEdit.class)
    };
}
