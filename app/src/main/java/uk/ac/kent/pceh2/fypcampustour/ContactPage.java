...
//contact page- users can type out email- on confirm button it takes them to their email client app to send
public class ContactPage extends AppCompatActivity
    ...
    //email address is stored in firebase and can be changed in admin
        ...
        buildingDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(ContactPage.this, "There is no email client installed.",
