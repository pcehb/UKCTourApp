...
//admin page to change email address used in contact page
public class ContactEdit extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buildingDatabase = FirebaseDatabase.getInstance().getReference().child("ContactEmail");

        final Button button = findViewById(R.id.set_changes_button);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                buildingDatabase.setValue(editEmail.getText().toString());
                Toast.makeText(ContactEdit.this, "Information Updated.",
